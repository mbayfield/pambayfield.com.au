	...
	{	// Our LightboxClass definition
		...
		domReady: function ( )
		{
			...
			$('#lightbox-nav-btnPrev').unbind().hover(function() { // over
				...
				var imgName = $.Lightbox.images.prev().src;
				var linkTracked = imgName.slice(imgName.lastIndexOf('/') + 1, imgName.indexOf('.'));
				var trackItem = '/lightbox/' + linkTracked.toLowerCase();
			...
			$('#lightbox-nav-btnNext').unbind().hover(function() { // over
				...
				// Track with Google Analytics
				var imgName = $.Lightbox.images.next().src;
				var linkTracked = imgName.slice(imgName.lastIndexOf('/') + 1, imgName.indexOf('.'));
				var trackItem = '/lightbox/' + linkTracked.toLowerCase();
				//pageTracker._trackPageview( trackItem );
